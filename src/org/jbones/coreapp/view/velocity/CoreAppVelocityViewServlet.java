...
public class CoreAppVelocityViewServlet extends VelocityViewServlet {
   
   public Template handleRequest(HttpServletRequest request,HttpServletResponse response, Context context) {
      try {

         System.out.println("in CoreAppVelocityViewServlet.handleRequest()");
         String name = "World";
         
         if (request.getParameter("str") != null) {
            name = request.getParameter("str");
         }
         
         context.put("str",name);
